...
<a href="" id="top"></a>
    ...
    <nav class="navbar" id="navbar">
      <ul class="nav-menu">
        ...
        <li class="nav-item" id="pj"><a href="../projets/index.html">Projets</a>
        <ul class="Projets">
          <li class="Subnav-item" id="na"><a href="../projets/index.html">Projets Nationaux</a></li>
          <li class="Subnav-item" id="in"><a href="../projets/index.html">Projets Internationaux</a></li>
        </ul>
        </li>
       ...
       <div class="pub_container"> 
         ...
         <div class="Topic-cards"> 
             <div class="Topics Topic1"> 
                 ...
                 <div class="topic-btn"> 
                    <a href="#sec_container">Publication et communication</a>
                 </div>
             </div>
             <div class="Topics Topic2"> 
              
                <div class="topic-btn"> 
                   <a href="#third_container"> Theses et
                    Memoires
                  </a>
                </div>
            </div>
            <div class="Topics Topic3"> 
                ...
                <div class="topic-btn"> 
                    <a href="#fourth_container">Evenements Scientifiques</a>
                </div>
            </div>
         </div>
    </div>
    ...
    <div class="card" >
        <div class="first-content"><span><?php echo $document['titre']; ?></span></div>
        <div class="second-content">
            <p>Type: <?php echo $document['type']; ?></p>
            <p>Auteur: <?php echo $document['Auteur']; ?></p>
            <p>Date: <?php echo $document['date']; ?></p>
            <p>nom publication: <?php echo $document['nom_pub']; ?></p>
            <p>link: <?php echo '<a href="'.$document['link'].'">acceder</a>'; ?></p>
        </div>
    </div>
    <?php endforeach; ?>
</div>
...
<div class="third_container" id="third_container"> 
    ...
    <div class="card" title="<?php echo $soutenance['nom'] . ', ' . $soutenance['prenom'] . ', ' . $soutenance['date'] . ', ' . $soutenance['titre'] .', '. $soutenance['lieu'];; ?>">
        <div class="first-content"><span><?php echo $soutenance['nom'].' ' . $soutenance['prenom'].'<br>'.$soutenance['grade']; ?></span></div>
        <div class="second-content">
            <p>Titre: <?php echo $soutenance['titre']; ?></p>
            <p>prenom: <?php echo $soutenance['prenom']; ?></p>
            <p>Lieu: <?php echo $soutenance['lieu']; ?></p>
        </div>
    </div>
    <?php endforeach; ?>
</div>
...
<h1>Evenment Scientifiques</h1>
    ...
    <div class="card" title="<?php echo $event['type'] . ', ' . $event['titre'] . ', ' . $event['date'] . ', ' . $event['lieu']; ?>">
        <div class="first-content"><span><?php echo $event['titre']; ?></span></div>
        <div class="second-content">
